...
import org.example.lab_sase.Domain.Validator.ValidationException;
import org.example.lab_sase.Domain.Validator.Validator;
import org.example.lab_sase.Domain.Validator.ValidatorLogin;
import javafx.stage.Stage;
...
public class Controller_login extends Service{
    ...
    public void open_main_page(ActionEvent actionEvent) {
        ...
        try{
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/lab_sase/Main_page.fxml"));
            Parent root = loader.load();
            Scene loginScene = new Scene(root);
