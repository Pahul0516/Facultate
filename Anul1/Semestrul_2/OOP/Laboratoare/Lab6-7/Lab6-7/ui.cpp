...
void ui::ui_adaugare()
{
	...
	try
	{
		...
		this->contr.contr_adauga_eveniment(id, titlul, descrierea, tipul, durata);
...
void ui::ui_filtrare()
{
	...
	cin >> numar;
	lista_filtrata = this->contr.filtrare(numar);
...
void ui::ui_sortare()
{
	...
	lista_sortata = this->contr.sortare_dupa_durata();
...
void ui::ui_adaugare_lista_dupa_nume()
{
	...
	cin >> nume;
	this->contr.adauga_activitati(this->contr.contr_get_repository(this->contr).get_all(), nume);
	cout << "\n\x1B[37m\x1B[32mAdaugat cu succes" << "\x1B[37m";
}
